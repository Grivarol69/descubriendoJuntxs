        ...
        <>
            <div className="padreProyect">
                <div className="proyectLetra">
                    ...
                    <button onClick={toggleFavorite} className="corazon-btn">
                        {isFavorite ? "❤️" : "🤍"} {isFavorite ? "Quitar de favoritos" : "Agregar a favoritos"}
                    </button>

                    <div className="proyectDetailImage"></div>
